...
public class FindReplace extends JFrame implements ActionListener {
    ...
    public void doFindText(String find) {
        ...
        if (nextPosn >= 0) {
            int line = getLineNumber(jTextPane, nextPosn + find.length());
            System.out.print(line);
            jTextPane.setSelectionStart(nextPosn - line); // position cursor at word start 
            jTextPane.setSelectionEnd(nextPosn + find.length() - line + 1);
